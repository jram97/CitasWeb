                        ...
                        <form role="form">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <c:forEach items="${namedoct}" var="c">
                                        <option value="${c.codigo}"><c:out value="${c.nombre} ${c.apellido}" /></option>
                                    </c:forEach>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="persona" class="form-control" disabled="">
                                    <c:forEach items="${namepers}" var="c">
                                        <option value="${c.codigo}"><c:out value="${c.nombre} ${c.apellido}" /></option>
                                    </c:forEach>
                                </select></div>
